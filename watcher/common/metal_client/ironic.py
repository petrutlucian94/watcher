...
class IronicClient(base.BaseMetalClient):
    @property
    def _client(self):
    ...
    def list_compute_nodes(self):
        # TODO: use consistent variable and attribute names
        out_list = []
    ...
    def get_node(self, node_id):
        ironic_node = self._client.node.get(node_id).to_dict()
        compute_node_id = ironic_node['extra']['compute_node_id']
